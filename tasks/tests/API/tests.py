...
class BaseApiTest(APITestCase):
    ...
    def test_tasksList(self):
        ...
        self.assertEqual(task1.user.first_name, response.json()['user']['first_name'])
        self.assertEqual(task1.user.last_name, response.json()['user']['last_name'])
        ...
        self.assertEqual(task2.user.first_name, response.json()['user']['first_name'])
        self.assertEqual(task2.user.last_name, response.json()['user']['last_name'])
