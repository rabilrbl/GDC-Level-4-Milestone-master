...
urlpatterns = [
    ...
    path("complete_task/<int:pk>/", CompleteTaskView.as_view(), name="complete-task"),
    path("tasks/", GenericListView.as_view(), name="tasks"),
    path("user/signup/", SignUpView.as_view(), name="signup"),
    path("user/login/", LoginView.as_view(), name="login"),
    path("user/logout/", LogoutView.as_view(), name="logout"),
    path("login/", RedirectView.as_view(url="/user/login/", permanent=True), name="login_redirect"),
    path("signup/", RedirectView.as_view(url="/user/signup/", permanent=True), name="signup_redirect"),
    path("logout/", RedirectView.as_view(url="/user/logout/", permanent=True), name="logout_redirect"),
